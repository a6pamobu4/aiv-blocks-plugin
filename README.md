...
The repository root is the plugin directory. Clone or copy this repository into `wp-content/plugins/aiv-blocks`.

1. Place the repository at `wp-content/plugins/aiv-blocks`.
2. From `wp-content/plugins/aiv-blocks`, run `npm install`.
3. Run `npm run build`.
